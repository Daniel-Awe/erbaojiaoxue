...
public class JwtOperator {
    ...
    public  void test(String[] args) {
        ...
        jwtOperator.expirationTimeInSecond = 315360000L;
        ...
        objectObjectHashMap.put("roleId", 0);
        objectObjectHashMap.put("jump", 1);
        ...
        // 将我改成上面生成的token!!!
        String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE1ODYyNjYwMDksImV4cCI6MTU4NzQ3NTYwOX0.-Wjt8NGsBnEknw_Z8ZWViE66XvbQyJU13v9njKnR9Z0";
        ...
        String encodedPayload = "eyJpZCI6IjEiLCJpYXQiOjE1ODYyNjYwMDksImV4cCI6MTU4NzQ3NTYwOX0";
        // 测试5: 解密Payload
